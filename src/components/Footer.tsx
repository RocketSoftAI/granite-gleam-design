        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-primary-foreground/60 text-sm leading-relaxed mb-6">
              Crafting exceptional stone countertops for Northern Colorado homeowners since 2003.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Portfolio', 'Materials', 'Our Process', 'About Us', 'Contact'].map((link) => (
                <li key={link}>
                  <a
                    href="#"
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Granite Countertops', 'Quartz Countertops', 'Marble Countertops', 'Quartzite Countertops', 'Slab Gallery'].map((link) => (
                <li key={link}>
                  <a
                    href="#"
                    className="text-primary-foreground/60 hover:text-primary-foreground transition-colors text-sm"
      ...
      <div className="border-t border-primary-foreground/10">
        <div className="container mx-auto px-6 lg:px-12 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <a href="#" className="text-sm text-primary-foreground/50 hover:text-primary-foreground/70 transition-colors">
              Privacy Policy
            </a>
            <a href="#" className="text-sm text-primary-foreground/50 hover:text-primary-foreground/70 transition-colors">
              Terms of Service
