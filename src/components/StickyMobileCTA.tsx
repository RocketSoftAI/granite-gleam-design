...
const StickyMobileCTA = () => {
  ...
  return (
    <div
      className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-md border-t border-border shadow-elevated safe-area-bottom animate-fade-in"
    >
      <button
